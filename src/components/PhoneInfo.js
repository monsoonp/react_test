...
class PhoneInfo extends Component {
    ...
    componentDidUpdate(prevProps, prevState){
        ...
        if(!prevState.editing && this.state.editing){   // editing 값이 false -> true 로 전환 될 때  // info 의 값을 state 에 넣어준다
            this.setState({
                name: info.name,
                phone: info.phone
            })
    ...
    shouldComponentUpdate(nextProps, nextState){
        // 수정 상태가 아니고 info 값이 같다면 리렌더링 하지 않음   / PhoneList가 전달받는 data가 다르므로 shouldComponentUpdate true, 
